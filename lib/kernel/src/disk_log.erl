...
terms2bins([]=Nil) ->
    Nil;
terms2bins([T1,T2,T3,T4,T5,T6,T7,T8]) ->
    [term_to_binary(T1),
      term_to_binary(T2),
      term_to_binary(T3),
      term_to_binary(T4),
      ...
      term_to_binary(T7),
      term_to_binary(T8)];
terms2bins([T1,T2,T3,T4,T5,T6,T7]) ->
    [term_to_binary(T1),
      term_to_binary(T2),
      term_to_binary(T3),
      term_to_binary(T4),
...
terms2bins([T1,T2,T3,T4,T5,T6]) ->
    [term_to_binary(T1),
      ...
      term_to_binary(T5),
      term_to_binary(T6)];
terms2bins([T1,T2,T3,T4,T5]) ->
    [term_to_binary(T1),
      term_to_binary(T2),
      term_to_binary(T3),
      term_to_binary(T4),
      term_to_binary(T5)];
terms2bins([T1,T2,T3,T4]) ->
    [term_to_binary(T1),
      term_to_binary(T2),
      term_to_binary(T3),
      term_to_binary(T4)];
...
terms2bins([T1]) ->
    [term_to_binary(T1)];
terms2bins([T1,T2,T3,T4,T5,T6,T7,T8|Ts]) ->
    [term_to_binary(T1),
      term_to_binary(T2),
      term_to_binary(T3),
      term_to_binary(T4),
      ...
      term_to_binary(T6),
      term_to_binary(T7),
      term_to_binary(T8) | terms2bins(Ts)].
